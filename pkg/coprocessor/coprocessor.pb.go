...
type Request struct {
	...
	// Only used in TiFlash, represents region is not on local machine and should read from another TiFlash node through coprocessor.
	IsRemoteRead         bool     `protobuf:"varint,11,opt,name=is_remote_read,json=isRemoteRead,proto3" json:"is_remote_read,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *Request) GetIsRemoteRead() bool {
	if m != nil {
...
var fileDescriptor_29878c170c3dd019 = []byte{
	...
	,
}
