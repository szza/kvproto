...
type Request struct {
	...
	Priority             uint64   `protobuf:"varint,11,opt,name=priority,proto3" json:"priority,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *Request) GetPriority() uint64 {
	if m != nil {
		return m.Priority
	}
	return 0
...
type Response struct {
	...
	VirtualTime          uint64   `protobuf:"varint,13,opt,name=virtual_time,json=virtualTime,proto3" json:"virtual_time,omitempty"`
	Cost                 uint64   `protobuf:"varint,14,opt,name=cost,proto3" json:"cost,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *Response) GetVirtualTime() uint64 {
	if m != nil {
...
func (m *Response) GetCost() uint64 {
	if m != nil {
		return m.Cost
	}
	return 0
...
var fileDescriptor_29878c170c3dd019 = []byte{
	...
	,
}
...
func (m *Request) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Priority != 0 {
		i = encodeVarintCoprocessor(dAtA, i, uint64(m.Priority))
		i--
		dAtA[i] = 0x58
	}
	if m.PagingSize != 0 {
...
func (m *Response) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Cost != 0 {
		i = encodeVarintCoprocessor(dAtA, i, uint64(m.Cost))
		i--
		dAtA[i] = 0x70
	}
	if m.VirtualTime != 0 {
		i = encodeVarintCoprocessor(dAtA, i, uint64(m.VirtualTime))
		i--
		dAtA[i] = 0x68
	}
...
func (m *Request) Size() (n int) {
	...
	if m.Priority != 0 {
		n += 1 + sovCoprocessor(uint64(m.Priority))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *Response) Size() (n int) {
	...
	if m.VirtualTime != 0 {
		n += 1 + sovCoprocessor(uint64(m.VirtualTime))
	}
	if m.Cost != 0 {
		n += 1 + sovCoprocessor(uint64(m.Cost))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
