...
type PITRPhase1 struct {
	StartVersion         uint64   `protobuf:"varint,1,opt,name=start_version,json=startVersion,proto3" json:"start_version,omitempty"`
	Tso                  uint64   `protobuf:"varint,2,opt,name=tso,proto3" json:"tso,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *PITRPhase1) Reset()         { *m = PITRPhase1{} }
func (m *PITRPhase1) String() string { return proto.CompactTextString(m) }
func (*PITRPhase1) ProtoMessage()    {}
func (*PITRPhase1) Descriptor() ([]byte, []int) {
	return fileDescriptor_1afe832be69693c7, []int{4}
}
func (m *PITRPhase1) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *PITRPhase1) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_PITRPhase1.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *PITRPhase1) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PITRPhase1.Merge(m, src)
}
func (m *PITRPhase1) XXX_Size() int {
	return m.Size()
}
func (m *PITRPhase1) XXX_DiscardUnknown() {
	xxx_messageInfo_PITRPhase1.DiscardUnknown(m)
}

var xxx_messageInfo_PITRPhase1 proto.InternalMessageInfo

func (m *PITRPhase1) GetStartVersion() uint64 {
	if m != nil {
...
func (m *PITRPhase1) GetTso() uint64 {
	if m != nil {
		return m.Tso
	}
	return 0
...
func (m *PITRPhase2) Reset()         { *m = PITRPhase2{} }
func (m *PITRPhase2) String() string { return proto.CompactTextString(m) }
func (*PITRPhase2) ProtoMessage()    {}
func (*PITRPhase2) Descriptor() ([]byte, []int) {
	return fileDescriptor_1afe832be69693c7, []int{5}
}
func (m *PITRPhase2) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *PITRPhase2) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_PITRPhase2.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *PITRPhase2) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PITRPhase2.Merge(m, src)
}
func (m *PITRPhase2) XXX_Size() int {
	return m.Size()
}
func (m *PITRPhase2) XXX_DiscardUnknown() {
	xxx_messageInfo_PITRPhase2.DiscardUnknown(m)
}

var xxx_messageInfo_PITRPhase2 proto.InternalMessageInfo

func (m *PITRPhase2) GetStartVersion() uint64 {
	if m != nil {
		return m.StartVersion
	}
	return 0
...
func (m *PITRPhase2) GetTso() uint64 {
	if m != nil {
		return m.Tso
	}
	return 0
...
func (m *PITRPhase2) GetCommitVersion() uint64 {
	if m != nil {
...
type PrewriteRequest struct {
	...
	Priority             uint64         `protobuf:"varint,16,opt,name=priority,proto3" json:"priority,omitempty"`
	XXX_NoUnkeyedLiteral struct{}       `json:"-"`
	XXX_unrecognized     []byte         `json:"-"`
	XXX_sizecache        int32          `json:"-"`
}
...
func (m *PrewriteRequest) GetPriority() uint64 {
	if m != nil {
		return m.Priority
	}
	return 0
...
type PrewriteResponse struct {
	...
	VirtualTime          uint64         `protobuf:"varint,6,opt,name=virtual_time,json=virtualTime,proto3" json:"virtual_time,omitempty"`
...
func (m *PrewriteResponse) GetVirtualTime() uint64 {
	if m != nil {
...
func (m *PrewriteResponse) GetCost() uint64 {
	if m != nil {
		return m.Cost
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*PITRPhase1)(nil), "kvrpcpb.PITRPhase1")
	proto.RegisterType((*PITRPhase2)(nil), "kvrpcpb.PITRPhase2")
...
var fileDescriptor_1afe832be69693c7 = []byte{
	...
	,
}
...
func (m *PITRPhase1) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *PITRPhase1) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PITRPhase1) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.Tso != 0 {
		i = encodeVarintKvrpcpb(dAtA, i, uint64(m.Tso))
		i--
		dAtA[i] = 0x10
	}
	if m.StartVersion != 0 {
...
func (m *PITRPhase2) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *PITRPhase2) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PITRPhase2) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *PrewriteResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Cost != 0 {
		i = encodeVarintKvrpcpb(dAtA, i, uint64(m.Cost))
		i--
		dAtA[i] = 0x38
	}
	if m.VirtualTime != 0 {
		i = encodeVarintKvrpcpb(dAtA, i, uint64(m.VirtualTime))
		i--
		dAtA[i] = 0x30
	}
	if m.ExecDetailsV2 != nil {
...
func (m *PrewriteRequest) Size() (n int) {
	...
	if m.Priority != 0 {
		n += 2 + sovKvrpcpb(uint64(m.Priority))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *PrewriteResponse) Size() (n int) {
	...
	if m.VirtualTime != 0 {
		n += 1 + sovKvrpcpb(uint64(m.VirtualTime))
	}
	if m.Cost != 0 {
		n += 1 + sovKvrpcpb(uint64(m.Cost))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *PITRPhase1) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PITRPhase1: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PITRPhase1: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *PITRPhase2) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PITRPhase2: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PITRPhase2: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *PrewriteResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field VirtualTime", wireType)
			}
			m.VirtualTime = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.VirtualTime |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
